      ...
      <div className="container-xl relative grid lg:grid-cols-[1.05fr_0.95fr] gap-16 items-center">
        <div>
          <motion.span
            ...
            className="relative block w-16 h-16 rounded-full overflow-hidden ring-1 ring-gold/30 mb-8"
          >
            <Image
              src="/logo-mark.png"
              alt="Isabella Cortez"
        ...
        >
          ...
          <div className="relative w-[300px] h-[380px] sm:w-[360px] sm:h-[460px] rounded-[1.75rem] overflow-hidden shadow-soft bg-navy-950">
            <Image
              src="/foto-hero.jpg"
              ...
              priority
            />
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-navy-950/95 via-navy-950/40 to-transparent">
