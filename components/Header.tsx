    ...
    >
      <div className="container-xl flex items-center justify-between h-20">
        <a href="#inicio" className="flex items-center gap-3 group">
          <span className="relative w-11 h-11 rounded-full overflow-hidden bg-navy-950 shrink-0 ring-1 ring-gold/30">
            <Image
              src="/logo-mark.png"
              alt="Isabella Cortez"
              fill
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-navy-950 lg:hidden overflow-y-auto"
          >
            <div className="container-xl flex items-center justify-between h-20">
